...
- [RE-HOOK-003：Hook 参数应该接受值、配置还是 Callback](#lesson-re-hook-003)
- [RE-HOOK-004：Hook 返回 Tuple 还是 Object](#lesson-re-hook-004)
...
- [RE-STORE-001：什么叫 External Mutable Store](#lesson-re-store-001)
- [RE-STORE-002：为什么手工 useEffect + setState 订阅可能不够可靠](#lesson-re-store-002)
- [RE-STORE-003：第一个 useSyncExternalStore](#lesson-re-store-003)
- [RE-STORE-004：getSnapshot 为什么必须返回可缓存的稳定 Snapshot](#lesson-re-store-004)
- [RE-STORE-005：subscribe 函数 Identity 为什么重要](#lesson-re-store-005)
- [RE-STORE-006：Tearing 是什么](#lesson-re-store-006)
- [RE-STORE-007：getServerSnapshot 为什么存在](#lesson-re-store-007)
- [RE-STORE-008：用 useSyncExternalStore 封装 Browser Online State](#lesson-re-store-008)
- [RE-STORE-009：用 useSyncExternalStore 封装 LocalStorage Store](#lesson-re-store-009)
