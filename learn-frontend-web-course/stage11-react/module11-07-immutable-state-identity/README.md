...
> [← Module 11.06：State Fundamentals、Render Snapshot、Update Queue 与 Batching](../module11-06-state-snapshot-queue-batching/README.md) · [↑ Stage 11 总纲](../README.md) · [Module 11.08：State Modeling 与 Ownership →](../module11-08-state-modeling-ownership/README.md)
...
- [RE-IMMUTABLE-001：Primitive State 与 Reference State 有什么本质差异](#lesson-re-immutable-001)
- [RE-IMMUTABLE-002：直接修改对象以后为什么 UI 可能不更新](#lesson-re-immutable-002)
- [RE-IMMUTABLE-003：Shallow Copy 到底复制了什么](#lesson-re-immutable-003)
- [RE-IMMUTABLE-004：正确更新一层 Object State](#lesson-re-immutable-004)
- [RE-IMMUTABLE-005：Nested Object State 应该怎么更新](#lesson-re-immutable-005)
- [RE-IMMUTABLE-006：Array append / prepend / remove / replace 的不可变写法](#lesson-re-immutable-006)
- [RE-IMMUTABLE-007：Array sort / reverse 为什么特别容易误改 State](#lesson-re-immutable-007)
- [RE-IMMUTABLE-008：数组中的对象怎么更新](#lesson-re-immutable-008)
- [RE-IMMUTABLE-009：为什么“深拷贝一切”不是正确答案](#lesson-re-immutable-009)
- [RE-IMMUTABLE-010：Immer 的 Draft 为什么看起来可以直接修改](#lesson-re-immutable-010)
- [RE-IMMUTABLE-011：什么时候值得使用 Immer，什么时候普通更新更清晰](#lesson-re-immutable-011)
- [RE-IMMUTABLE-012：Structural Sharing 与 Render Performance 有什么关系](#lesson-re-immutable-012)
- [RE-IMMUTABLE-013：Mutation Bug 为什么在复杂 React 中更难排查](#lesson-re-immutable-013)
- [RE-IMMUTABLE-014：State Shape 不合理会让不可变更新变得多痛苦](#lesson-re-immutable-014)
- [RE-IMMUTABLE-015：综合实现——可编辑订单行的不可变更新](#lesson-re-immutable-015)
- [RE-IDENTITY-001：State 为什么必须绑定到某个组件身份](#lesson-re-identity-001)
- [RE-IDENTITY-002：相同位置 + 相同 Component Type 会发生什么](#lesson-re-identity-002)
- [RE-IDENTITY-003：相同位置换成不同 Component Type 会发生什么](#lesson-re-identity-003)
- [RE-IDENTITY-004：JSX 代码位置和 Tree Position 是一回事吗](#lesson-re-identity-004)
- [RE-IDENTITY-005：Key 如何主动改变组件身份](#lesson-re-identity-005)
- [RE-IDENTITY-006：为什么把 Component Definition 写在另一个 Component 内部会重置 State](#lesson-re-identity-006)
- [RE-IDENTITY-007：表单什么时候应该保留，什么时候应该重置](#lesson-re-identity-007)
- [RE-IDENTITY-008：Tabs 切换为什么默认可能丢失隐藏页面 State](#lesson-re-identity-008)
- [RE-IDENTITY-009：Modal / Drawer 关闭后 State 应不应该消失](#lesson-re-identity-009)
- [RE-IDENTITY-010：State Preservation 与 DOM Preservation 是一回事吗](#lesson-re-identity-010)
- [RE-IDENTITY-011：如何用 React DevTools 判断组件到底被更新还是重新挂载](#lesson-re-identity-011)
- [RE-IDENTITY-012：Identity Bug 综合——错误 Key、Nested Component、条件树](#lesson-re-identity-012)
- [RE-IDENTITY-013：从 Identity 高层模型连接到 Reconciler](#lesson-re-identity-013)

</details>
<!-- LESSON_NAV:END -->

<a id="lesson-re-immutable-001"></a>
...
<a id="lesson-re-immutable-013"></a>
