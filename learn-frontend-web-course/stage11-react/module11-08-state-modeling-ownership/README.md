...
> [← Module 11.07：Immutable State 与 Component Identity](../module11-07-immutable-state-identity/README.md) · [↑ Stage 11 总纲](../README.md) · [Module 11.09：React Form 完整体系 →](../module11-09-form/README.md)
...
- [RE-MODELING-001：什么数据才有资格成为 State](#lesson-re-modeling-001)
- [RE-MODELING-002：Derived State 为什么通常不应该再存一份](#lesson-re-modeling-002)
- [RE-MODELING-003：Duplicate State 为什么最终一定会产生冲突](#lesson-re-modeling-003)
- [RE-MODELING-004：Redundant State 与 Cache 有什么区别](#lesson-re-modeling-004)
- [RE-MODELING-005：Impossible State 是怎么被设计出来的](#lesson-re-modeling-005)
- [RE-MODELING-006：State Shape 应该按 UI 结构还是业务关系设计](#lesson-re-modeling-006)
- [RE-MODELING-007：什么时候应该 Normalize State](#lesson-re-modeling-007)
- [RE-MODELING-008：State Ownership 到底是什么意思](#lesson-re-modeling-008)
- [RE-MODELING-009：Lifting State Up 的代价是什么](#lesson-re-modeling-009)
- [RE-MODELING-010：Controlled 与 Uncontrolled State 应该怎么选](#lesson-re-modeling-010)
- [RE-MODELING-011：Local State、Shared State、Global State 不是三个库](#lesson-re-modeling-011)
- [RE-MODELING-012：URL State 为什么不能随便复制到 useState](#lesson-re-modeling-012)
- [RE-MODELING-013：Server State 为什么不是普通 Global State](#lesson-re-modeling-013)
- [RE-MODELING-014：Persistent State 为什么有独立生命周期](#lesson-re-modeling-014)
- [RE-MODELING-015：Transient UI State 应该离业务数据多远](#lesson-re-modeling-015)
- [RE-MODELING-016：State Colocation 为什么通常是默认好策略](#lesson-re-modeling-016)
- [RE-MODELING-017：State Modeling Code Review——删掉一半 State](#lesson-re-modeling-017)
- [RE-MODELING-018：输出一张真实应用 State Ownership Map](#lesson-re-modeling-018)

</details>
<!-- LESSON_NAV:END -->

<a id="lesson-re-modeling-001"></a>
### Lesson RE-MODELING-001：什么数据才有资格成为 State

建立 State 的最小判定：是否随时间变化、是否影响 Render、能否由现有输入计算得到。

<a id="lesson-re-modeling-002"></a>
### Lesson RE-MODELING-002：Derived State 为什么通常不应该再存一份

用 items + total、firstName + fullName 等案例制造同步 Bug，改为 Render 期间计算。

<a id="lesson-re-modeling-003"></a>
### Lesson RE-MODELING-003：Duplicate State 为什么最终一定会产生冲突

把同一实体同时存在多个 State 中，制造更新不一致并学习 Single Source of Truth。

<a id="lesson-re-modeling-004"></a>
### Lesson RE-MODELING-004：Redundant State 与 Cache 有什么区别

区分“为了方便重复保存”和“有明确成本模型的 memo/cache”，避免用性能借口破坏数据一致性。

<a id="lesson-re-modeling-005"></a>
