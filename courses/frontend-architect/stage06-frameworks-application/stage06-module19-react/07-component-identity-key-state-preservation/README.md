...
| RE-KP063 | 组件类型变化导致状态重置 | Type Change / Unmount / Reset | [文档](./kp063-component-type-change-reset/README.md) · [源码](./kp063-component-type-change-reset/src/main.jsx) | 已重构 · v1.0 |
| RE-KP064 | key 不只是列表警告 | Identity Hint / Sibling Scope / key Prop | [文档](./kp064-key-beyond-list-warning/README.md) · [源码](./kp064-key-beyond-list-warning/src/main.jsx) | 已重构 · v1.0 |
| RE-KP065 | 使用 key 主动重置状态 | Reset Form / Entity Identity / Key Change | [文档](./kp065-key-reset-state/README.md) · [源码](./kp065-key-reset-state/src/main.jsx) | 已重构 · v1.0 |
| RE-KP066 | 列表 key 的稳定性要求 | Stable ID / Reorder / Local State | [文档](./kp066-list-key-stability/README.md) · [源码](./kp066-list-key-stability/src/main.jsx) | 已重构 · v1.0 |
| RE-KP067 | 为什么不能滥用数组索引 key | Index Key / Insert Delete Reorder / Misalignment | [文档](./kp067-index-key-problems/README.md) · [源码](./kp067-index-key-problems/src/main.jsx) | 已重构 · v1.0 |
| RE-KP068 | 随机 key 的问题 | Random Key / Remount / Input Loss | [文档](./kp068-random-key-problems/README.md) · [源码](./kp068-random-key-problems/src/main.jsx) | 已重构 · v1.0 |
