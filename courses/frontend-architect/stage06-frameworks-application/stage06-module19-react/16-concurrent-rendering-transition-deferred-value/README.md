...
| RE-KP152 | Urgent Update 与 Non-urgent Update | 1. Input Priority 2. Background Work 3. UX | `kp152-urgent-vs-non-urgent-update/` | 待生成 |
| RE-KP153 | startTransition | 1. startTransition 2. Transition Update 3. Interruptible | `kp153-start-transition/` | 待生成 |
| RE-KP154 | useTransition | 1. Hook 2. startTransition 3. Pending | `kp154-use-transition/` | 待生成 |
| RE-KP155 | isPending | 1. Pending Feedback 2. UX 3. Transition State | `kp155-is-pending/` | 待生成 |
| RE-KP156 | Transition 中的异步更新 | 1. async Action 2. await 3. Nested Transition | `kp156-async-transition-updates/` | 待生成 |
| RE-KP157 | Action 与 Transition 的关系 | 1. Action 2. Transition 3. Async Flow | `kp157-action-transition-relationship/` | 待生成 |
...
- Chapter 16：**1 / 10**
- 下一知识点：**RE-KP152：Urgent Update 与 Non-urgent Update**
