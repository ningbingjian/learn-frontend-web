...
| RE-KP182 | 带 key 的 Fragment | 1. Fragment Key 2. Explicit Syntax 3. List | `kp182-keyed-fragment/` | 待生成 |
| RE-KP183 | StrictMode | 1. Development Checks 2. Scope 3. No Production Cost | `kp183-strict-mode/` | 待生成 |
| RE-KP184 | StrictMode 的双 Render 检查 | 1. Double Render 2. Impurity 3. Development | `kp184-strictmode-double-render-check/` | 待生成 |
| RE-KP185 | StrictMode 的 Effect 检查 | 1. Setup 2. Cleanup 3. Re-run | `kp185-strictmode-effect-check/` | 待生成 |
| RE-KP186 | Profiler | 1. Measure 2. Tree Scope 3. onRender | `kp186-profiler/` | 待生成 |
| RE-KP187 | Profiler 回调指标 | 1. actualDuration 2. baseDuration 3. Phase | `kp187-profiler-callback-metrics/` | 待生成 |
...
- Chapter 19：**1 / 10**
- 下一知识点：**RE-KP182：带 key 的 Fragment**
