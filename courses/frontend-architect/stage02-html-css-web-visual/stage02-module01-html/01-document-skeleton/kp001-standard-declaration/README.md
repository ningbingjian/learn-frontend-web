...
新建一个新的 HTML 文件，自己完成下面过程：

1. 先不写 DOCTYPE。
2. 观察 `document.compatMode`。
3. 加上 `<!doctype html>`。
4. 再次观察模式。
5. 把结果显示到页面正文中。
...
> 为什么一个没有写 DOCTYPE 的 HTML 页面明明也能显示，我们仍然要在完整 HTML 文档第一行写 `<!doctype html>`？

如果你的回答中包含“浏览器文档模式”和“标准模式”，说明你已经抓住了本节核心。
